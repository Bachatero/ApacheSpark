...
#print 'Unique hosts per day: %s' % dailyHosts
...
#dayAndHostTuple = access_logs.sample(False,0.0001).map(lambda log: (log.date_time.day,log.host))
dayAndHostTuple = access_logs.map(lambda log: (log.date_time.day,log.host))

groupedByDay = dayAndHostTuple.groupByKey()

#print( groupedByDay.take(3) ) 
...
#print hoursWithErrors404.take(1)
